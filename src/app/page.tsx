...
import I from "../../public/Picsart_23-10-10_11-50-16-351-removebg-preview.png";
    ...
    >
      <main className="flex h-full gap-12  font-[family-name:var(--font-geist-mono)] ">
        ...
        >
          ...
          after:inset-0 after:bg-[_linear-gradient(_var(--background)_,_var(--background)_80%_)_] after:opacity-30 after:z-10 "
          >
            <Image
              src={I}
              width={500}
