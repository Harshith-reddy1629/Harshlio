...
export default function Header() {
  ...
  return (
    ...
    >
      {
        <div
          className={`grow transition-all duration-500 ease-in-out max-sm:hidden ${
            isScrolled
      ...
      <ul
        ...
        className={`group flex w-1/2 justify-between gap-2 text-lg transition-all duration-500 *:cursor-pointer *:text-center before:absolute before:bottom-[-1px] before:left-3 before:w-0 before:transition-all before:duration-1000 before:content-[''] after:absolute after:top-[-1px] after:right-3 after:h-[1px] after:w-0 after:transition-all after:duration-1000 after:content-[''] max-lg:grow md:*:flex-[_1_1_25%_] ${
          isScrolled
