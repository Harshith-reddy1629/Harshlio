...
export default function Homev2() {
  return (
    <>
      <div className="flex items-center gap-6 min-h-dvh overflow-hidden bg-size-[_5%_5%,cover,cover] pt-22 font-[family-name:var(--font-geist-mono)] *:flex-[1_1_50%] max-md:flex-col max-md:items-center max-md:gap-10 md:py-32 max-md:py-20 md:pt-42">
        <DeveloperProfile />
        <DeveloperBio />
      </div>
      <MyWorks />
