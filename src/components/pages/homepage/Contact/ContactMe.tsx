  ...
  return (
    <>
      <ContactDialog className="group/click absolute top-full left-4/5 -translate-1/2 rounded-full">
        ...
        />
        <ClickPointer className="peer/icon size-[43%] absolute top-1/2 left-1/2 z-10 -translate-1/2 cursor-pointer fill-white/50 transition-all duration-300 group-hover/click:fill-white/75 peer-hover:fill-white/75 hover:fill-white/75 max-md:size-5" />
      </ContactDialog>
    </>
  );
}
