...
export default function DeveloperProfile() {
  return (
    <div className="flex h-full w-1/2 items-center justify-center">
      <div className="group relative aspect-[4/5] w-72 before:absolute before:bottom-[-3.5px] before:left-1/2 before:h-[0.4px] before:w-5/3 before:-translate-1/2 before:bg-[radial-gradient(circle,_#ffffff,_transparent)] before:blur-[0px] before:content-[''] after:absolute after:top-[-2px] after:left-1/2 after:h-[1px] after:w-5/3 after:-translate-1/2 after:bg-[radial-gradient(circle,_#ffffff,_transparent)] after:blur-[0px] after:content-['']">
